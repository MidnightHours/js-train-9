...
function findElementGreaterThan(arr, num) {
  ...
  const result = arr.find((elem) => elem > num);
...
function findIndexByProperty(arr, name) {
  ...
  const result = arr.findIndex((elem) => elem.name === name);
...
function findLastEvenNumber(arr) {
  ...
  const result = arr.findLast((elem) => elem % 2 === 0);
...
function getSubArrayAndConvertToString(arr, startIdx) {
  ...
  const result = arr.slice(startIdx);
...
function getPositiveArrayValues(arr) {
  ...
  const newArray = Array.from(iter);

  const result = newArray.filter((elem) => elem > 0);
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  const newArr2 = newArr1.map((elem) => elem * elem);

  return newArr2.filter((elem) => elem > threshold);
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  const sum = sliceArr.reduceRight((accum, value) => {
    console.log(value);
    return accum + value;
  }, 0);
...
function expandArrayByN(arr, n) {
  ...
  const result = arr.flatMap((elem) => Array(n).fill(elem));
...
function findLongestWord(arr) {
  ...
  const longWord = arr.reduce((longest, currentWord) => {
...
function calculateTotalPrice(arr) {
  ...
  const result = arr.reduce((total, product) => {
...
function findLastNegativeNumberIndex(arr) {
  ...
  const result = arr.findLastIndex((num) => num < 0);
